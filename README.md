...
A command-line based student management system that performs full CRUD operations. It allows adding, viewing, searching, updating, and deleting student records with persistent storage using file handling.
...
* GUI-based applications (Tkinter)
* Web-based projects
